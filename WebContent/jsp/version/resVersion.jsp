...
<body class="" style="overflow-x:hidden">
	...
	<div class="row-fluid">
		<div class="page-container" style="margin: 0px">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="/robot_web/node/download_checked_package?fileType=res" method="post" >
						<div class="portlet box blue">
				      		<div class="portlet-title">
				            	<div class="caption">资源版本号</div>
				            	<div class="actions">
				            		<ss:display roles="1,2">
					            		<a class=" btn default green" onclick="load('/robot_web/version/upload_res')" title="" data-target="#ajax" data-toggle="modal"><tt:i18n name="upload"/></a>
				            		...
				            		<a class=" btn default green" href="/robot_web/node/download_version_package?fileType=res" title="" >下载最新资源包</a>
					        ...
					        <div class="portlet-body">
					            <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
					               	...
					               	<tbody>
					               		<c:forEach items="${result.resVersion}" var="item" varStatus="status">
						               		<tr class="odd gradeX">
						               			<td><input name="res" type="checkbox" value="${item.key}" /></td>
												<td>${status.count}</td>
												<td>${item.key}</td>
						                     	<td>${item.value}</td>
						                     	<td></td>
	...
	<script src="/robot_web/js/version/resVersion.js" type="text/javascript"></script>
