	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><tt:i18n name="compensateGold"/></h4>
			</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="portlet-body form">
									<form id="form1" class="form-horizontal" action="/robot_web/player/compensate_gold" method="post" style="margin:0 0 0 0">
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="input-icon col-md-8">
													<input class="form-control placeholder-no-fix" type="text" autocomplete="off" id="gold" name="gold" required/>
												</div>
												<span class="help-block" style="color:red;">*</span>
											</div>
										</div>
