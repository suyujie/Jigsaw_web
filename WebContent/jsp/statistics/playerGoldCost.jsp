...
<body class="" style="overflow-x:hidden">
				...
				<div class="col-md-12">
					<div class="portlet box blue" >
						<div class="portlet-title">
							<div class="caption"><tt:i18n name="playerGoldCostStatistics"/></div>
							<div class="actions">
								<div class="btn-group">
									<table>
										<tr>
											<td>
												<button class="btn green" onclick="chart('${result.pgcArray}');"><tt:i18n name="lineChart"/></button>
											</td>
										</tr>
									</table>
								</div>
						...
						<div class="portlet-body">
							<div class="table-toolbar">
		                        <div class="note note-success">
									<form id="form1" action="/robot_web/statistics/player_gold_cost" method="post" style="margin:0 0 0 0">
										<div class="row">
											<div class="col-md-2">
							...
							<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
								<thead>
									<tr>
										...
										<th colspan="12"><tt:i18n name="dayGoldCost"/></th>
									</tr>
									<tr>
										<th><tt:i18n name="GoldType.paintCost"/></th>
										<th><tt:i18n name="GoldType.repairRobot"/></th>
										<th><tt:i18n name="GoldType.cancelRentOrderCost"/></th>
										<th><tt:i18n name="GoldType.getEggPartCost"/></th>
										<th><tt:i18n name="forceLottery"/></th>
										<th><tt:i18n name="GoldType.lottery"/></th>
										<th><tt:i18n name="GoldType.reflushRentOrder"/></th>
										<th><tt:i18n name="GoldType.robotPartUpCost"/></th>
										<th><tt:i18n name="GoldType.robotPartUpWithGoldCost"/></th>
										<th><tt:i18n name="GoldType.buyBlackItem"/></th>
										<th><tt:i18n name="GoldType.resetDeathWheel"/></th>
										<th><tt:i18n name="GoldType.bergUpgrade"/></th>
										<th><tt:i18n name="GoldType.resetBergWheel"/></th>
										<th><tt:i18n name="GoldType.reliveBergWheel"/></th>
										<th><tt:i18n name="GoldType.resetTreasureIsland"/></th>
										<th><tt:i18n name="GoldType.robotPartEvolutionCost"/></th>
										<th><tt:i18n name="costAmount"/></th>
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${result.paging.rows}" var="playerGoldCost" varStatus="status">
										<tr>
											<td>${playerGoldCost.dateTime}</td>
											<td>${playerGoldCost.todayPaintCost}</td>
											<td>${playerGoldCost.todayRepairRobotCost}</td>
											<td>${playerGoldCost.todayCancelRentOrderCost}</td>
											<td>${playerGoldCost.todayGetEggPartCost}</td>
											<td>${playerGoldCost.todayForceLotteryCost}</td>
											<td>${playerGoldCost.todayLotteryCost}</td>
											<td>${playerGoldCost.todayReflushRentOrderCost}</td>
											<td>${playerGoldCost.todayRobotPartUpCost}</td>
											<td>${playerGoldCost.todayRobotPartUpWithGoldCost}</td>
											<td>${playerGoldCost.todayBuyBlackItem}</td>
											<td>${playerGoldCost.todayResetDeathWheel}</td>
											<td>${playerGoldCost.todayBergUpgrade}</td>
											<td>${playerGoldCost.todayResetBergWheel}</td>
											<td>${playerGoldCost.todayReliveBergWheel}</td>
											<td>${playerGoldCost.todayResetTreasureIsland}</td>
											<td>${playerGoldCost.todayRobotPartEvolutionCost}</td>
											<td>${playerGoldCost.todayCostAmount}</td>
										</tr>
									</c:forEach>
									<tr>
										<th><tt:i18n name="total"/></th>
										<td>${result.total.totalPaintCost}</td>
										<td>${result.total.totalRepairRobotCost}</td>
										<td>${result.total.totalCancelRentOrderCost}</td>
										<td>${result.total.totalGetEggPartCost}</td>
										<td>${result.total.totalForceLotteryCost}</td>
										<td>${result.total.totalLotteryCost}</td>
										<td>${result.total.totalReflushRentOrderCost}</td>
										<td>${result.total.totalRobotPartUpCost}</td>
										<td>${result.total.totalRobotPartUpWithGoldCost}</td>
										<td>${result.total.totalBuyBlackItem}</td>
										<td>${result.total.totalResetDeathWheel}</td>
										<td>${result.total.totalBergUpgrade}</td>
										<td>${result.total.totalResetBergWheel}</td>
										<td>${result.total.totalReliveBergWheel}</td>
										<td>${result.total.totalResetTreasureIsland}</td>
										<td>${result.total.totalRobotPartEvolutionCost}</td>
										<td>${result.total.totalCostAmount}</td>
									</tr>
								</tbody>
							</table>
									...
									<tr>
										<td>
											<c:if test="${result.paging.page > 1}">
												<a id="previous" href="/robot_web/statistics/player_gold_cost?begin=${result.paging.begin-result.paging.rowNum}&rowNum=${result.paging.rowNum}&beginTime=${result.beginTime}&endTime=${result.endTime}"><tt:i18n name="previousPage"/></a>&nbsp;&nbsp;
											</c:if>
											<c:if test="${result.paging.page < result.paging.total}">
												<a id="next" href="/robot_web/statistics/player_gold_cost?begin=${result.paging.end+1}&rowNum=${result.paging.rowNum}&beginTime=${result.beginTime}&endTime=${result.endTime}"><tt:i18n name="nextPage"/></a>&nbsp;&nbsp;&nbsp;
											</c:if>
										</td>
										<td>
										...
										<td>
											<button id="export" value="/robot_web/export_xls?fileTag=6&beginTime=${result.beginTime}&endTime=${result.endTime}"><tt:i18n name="export"/></button>
										</td>
									</tr>
								</c:if>
							</table>
	...
	<script src="/robot_web/js/statistics/playerGoldCost.js" type="text/javascript"></script>
