...
public class SyncDBUtil extends DataAccessObject {
	...
	public static boolean execute(DBOperator dBOperator, Long tagId, String sql, Object[] args) {
		...
		logger.info("--execute--" + DbDebugUtil.toDebugSql(sql, args));
	...
	public static Map<String, Object> readMap(DBOperator dBOperator, Long tagId, String sql, Object[] args) {
		QueryRunner query = new QueryRunner();
		Connection conn = getConn(dBOperator, tagId);
		Map<String, Object> map = null;

		logger.info("--readMap1--" + DbDebugUtil.toDebugSql(sql, args));
	...
	public static Map<String, Object> readMap(DBOperator dBOperator, String sql, Object[] args) {
		...
		logger.info("--readMap2--" + DbDebugUtil.toDebugSql(sql, args));
	...
	public static List<Map<String, Object>> readList(DBOperator dBOperator, Long tagId, String sql, Object[] args) {
		QueryRunner query = new QueryRunner();
		Connection conn = getConn(dBOperator, tagId);
		List<Map<String, Object>> list = null;

		logger.info("--readList1--" + DbDebugUtil.toDebugSql(sql, args));
	...
	public static List<Map<String, Object>> readList(DBOperator dBOperator, String sql, Object[] args) {
		...
		logger.info("--readList2--" + DbDebugUtil.toDebugSql(sql, args));
