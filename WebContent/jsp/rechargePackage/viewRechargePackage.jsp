...
<body class="" style="overflow-x:hidden">
				...
				<div class="col-md-12">
					<div class="portlet box blue" >
						<div class="portlet-title">
							<div class="caption"><tt:i18n name="viewRechargePackage"/></div>
										...
										<div class="col-md-5">
											<c:choose>
												<c:when test="${result.rechargePackage.picUrl_s==null}">
													<img src="/robot_web/images/${result.rechargePackage.picUrl}.png" height="60" width="60" />
												</c:when>
												<c:otherwise>
													<img src="/robot_web/img?path=${result.rechargePackage.picUrl_s}" />
												</c:otherwise>
											</c:choose>
											<input id="picUrl" type="hidden" name="picUrl" size="30" value="${result.rechargePackage.picUrl }" readonly />
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label"><tt:i18n name="priority"/></label>
										<div class="col-md-5">
											<input id="priority" name="priority" type="text" class="form-control" value="${result.rechargePackage.priority }" readonly>
										</div>
										<div class="col-md-2">
											<span class="help-block" style="color:red">*</span>
										</div>
	...
	<script src="/robot_web/js/rechargePackage/viewRechargePackage.js" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>