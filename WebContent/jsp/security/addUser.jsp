...
<body class="" style="overflow-x:hidden;background-color:#FFF !important;">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><tt:i18n name="addUser"/></h4>
			</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="portlet-body form">
									<form id="form1" class="form-horizontal" action="/robot_web/user/add" method="post" style="margin:0 0 0 0">
										<div class="form-body">
											<div class="form-group">
												<label class="control-label col-md-2"><tt:i18n name="username"/></label>
												<div class="input-icon col-md-8">
													<i class="icon-user"></i>
													<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="username" id="username" name="username" required/>
												</div>
											...
											<div class="form-group">
												...
												<div class="input-icon col-md-8">
													<i class="icon-lock"></i>
													<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="初始密码与用户名相同" id="password" name="password" readonly disabled/>
												</div>
												<span class="help-block" style="color:red"></span>
											</div>
											<div class="form-group">
										...
										<div class="modal-footer">
											...
											<tt:i18n name="add"/><i class="m-icon-swapright m-icon-white"></i>
											</button>
										</div>
									</form>
								</div>
	...
	<script src="/robot_web/js/security/addUser.js" type="text/javascript"></script>
