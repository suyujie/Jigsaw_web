...
<body class="" style="overflow-x:hidden">
				...
				<div class="col-md-12">
					<div class="portlet box blue" >
						<div class="portlet-title">
							<div class="caption"><tt:i18n name="playerFeedback"/></div>
							<div class="actions">
								<div class="btn-group">
								</div>
							</div>
						...
						<div class="portlet-body">
							<c:forEach items="${result.paging.rows}" var="feedback" varStatus="status">
								<div class="table-toolbar">
									<div class="alert alert-block alert-success fade in">
										<button type="button" class="close" data-dismiss="alert"></button>
										<div class="row">
											<h6 class="col-md-2" style="color:black;">发表时间：${feedback.t}</h6>
											<h6 class="col-md-2" style="color:black;">玩家ID[${feedback.playerId}]</h6>
											<h6 class="col-md-2" style="color:black;">玩家邮箱：${feedback.email}</h6>
										</div>
										<p>${feedback.msg}</p>
									</div>
			                    </div>
									...
									<tr>
										<td>
											<c:if test="${result.paging.page > 1}">
												<a id="previous" href="/robot_web/feedback/feedbacks?begin=${result.paging.begin-result.paging.rowNum}&rowNum=${result.paging.rowNum}"><tt:i18n name="previousPage"/></a>&nbsp;&nbsp;
											</c:if>
											<c:if test="${result.paging.page < result.paging.total}">
												<a id="next" href="/robot_web/feedback/feedbacks?begin=${result.paging.end+1}&rowNum=${result.paging.rowNum}"><tt:i18n name="nextPage"/></a>&nbsp;&nbsp;&nbsp;
											</c:if>
										</td>
										<td>
	...
	<script src="/robot_web/js/player/feedbacks.js" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>