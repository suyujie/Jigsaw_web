...
public class Request {
	public static String sendRequest(String url, Map<String, Object> data, String requestMethod,
			Map<String, String> header, int timeOut) throws Exception {
		return sendRequest(url, data, requestMethod, header, timeOut, null);
	}

	public static String sendRequest(String url, Map<String, Object> data, String requestMethod,
			Map<String, String> header, int timeOut, String localPath) throws Exception {
		return sendRequest(url, data, requestMethod, header, timeOut, localPath, -1, 0);
	}

	public static String uploadFileByStream(String url, Map<String, Object> data, Map<String, String> header,
			int timeOut, InputStream inputStream, int length) throws Exception {
	...
	public static String sendRequest(String url, Map<String, Object> data, String requestMethod,
			Map<String, String> header, int timeOut, String localPath, long offset, int sliceSize) throws Exception {
		HttpClient httpClient = new DefaultHttpClient();
		httpClient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT, timeOut);
