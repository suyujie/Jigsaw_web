	...
	<div class="modal-dialog modal-wide">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><tt:i18n name="expBag"/></h4>
			</div>
							...
							<div class="col-md-12">
								<div class="portlet-body form">
									<form class="form-horizontal" action="" method="" style="margin:0 0 0 0">
										<div class="form-body">
											<c:forEach items="${result.expBag}" var="exp" varStatus="status">
												<label class="control-label col-md-2">lv${exp.key+1}：</label>
												<label class="control-label col-md-1">${exp.value}</label>
