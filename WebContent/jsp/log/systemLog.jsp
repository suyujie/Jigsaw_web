...
<body class="" style="overflow-x:hidden">
				...
				<div class="col-md-12">
					<div class="portlet box blue" >
						<div class="portlet-title">
							<div class="caption"><tt:i18n name="systemLog"/></div>
							<div class="actions">
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-toolbar">
		                        <div class="note note-success">
									<form id="form1" action="/robot_web/log/system_log" method="post" style="margin:0 0 0 0">
										<div class="row">
											<div class="col-md-2">
							...
							<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
								<thead>
									<tr>
										...
										<th><tt:i18n name="time"/></th>
										<th><tt:i18n name="content"/></th>
									</tr>
								</thead>
								<tbody>
									...
									<tr>
										<td>
											<c:if test="${result.paging.page > 1}">
												<a id="previous" href="/robot_web/log/system_log?begin=${result.paging.begin-result.paging.rowNum}&rowNum=${result.paging.rowNum}&operatorName=${result.operatorName}&time=${result.operateTime}"><tt:i18n name="previousPage"/></a>&nbsp;&nbsp;
											</c:if>
											<c:if test="${result.paging.page < result.paging.total}">
												<a id="next" href="/robot_web/log/system_log?begin=${result.paging.end+1}&rowNum=${result.paging.rowNum}&operatorName=${result.operatorName}&time=${result.operateTime}"><tt:i18n name="nextPage"/></a>&nbsp;&nbsp;&nbsp;
											</c:if>
										</td>
										<td>
	...
	<script src="/robot_web/js/log/systemLog.js" type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>